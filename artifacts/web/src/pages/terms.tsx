      ...
      <div className="pub-legal-body pub-section">
        <div className="pub-legal-grid pub-wrap">
          ...
          <div className="pub-legal-content">
            <p>Please read these Terms &amp; Conditions carefully before using GotThis. By accessing or using our service, you agree to be bound by these terms.</p>

            <h2 id="acceptance">1. Acceptance of Terms</h2>
            <p>By creating an account or using GotThis in any way, you confirm that you are at least 16 years old and that you agree to these Terms &amp; Conditions and our <Link href="/data-policy">Data Use Policy</Link>. If you do not agree, please do not use the service.</p>

            <h2 id="service">2. The Service</h2>
            <p>GotThis provides a WhatsApp-integrated goal tracking platform. We reserve the right to modify, suspend, or discontinue any part of the service at any time with reasonable notice. We will not be liable to you or any third party for any modification, suspension, or discontinuation of the service.</p>
            <p>GotThis is provided "as is." While we work hard to keep things running smoothly, we cannot guarantee uninterrupted availability.</p>
            ...
            <p>You agree not to use GotThis to:</p>
            <ul>
            ...
            <p>GotThis, its logo, interface design, and underlying software are owned by GotThis Ltd. and are protected by copyright and other intellectual property laws. You may not reproduce, distribute, or create derivative works without our express written permission.</p>
            ...
            <p>GotThis is a productivity and goal-tracking tool. It is not a medical, psychological, or professional coaching service. Nothing in the service constitutes professional advice. You use GotThis at your own risk.</p>
            <p>We do not guarantee that using GotThis will result in any particular outcome, habit formation, or goal achievement.</p>

            <h2 id="liability">9. Limitation of Liability</h2>
            <p>To the fullest extent permitted by law, GotThis Ltd. shall not be liable for any indirect, incidental, special, consequential, or punitive damages arising from your use of the service. Our total liability to you for any claim shall not exceed the amount you paid us in the three months preceding the claim.</p>
            ...
            <p>For questions about these Terms, please contact us at <a href="mailto:legal@gotthis.one">legal@gotthis.one</a> or via our <Link href="/contact">Contact page</Link>.</p>
          </div>
        </div>
      </div>
    </PublicLayout>
