...
const sections: FaqSection[] = [
  {
    ...
    items: [
      {
        q: "What is GotThis?",
        a: "GotThis is a WhatsApp-first goal tracking assistant. You set up your goals on the dashboard, then simply text your progress to a WhatsApp number. Our AI reads your messages, updates the right goals, and keeps your dashboard growing — no new apps, no habits to form other than the ones you already have.",
      },
      {
        q: "Do I need to download anything?",
        a: "No. You only need a WhatsApp account (which you already have) and access to a web browser to view your dashboard. GotThis does not require you to install any app.",
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: "Yes — if you've enabled daily check-ins in your settings, GotThis will send you a morning nudge to log your progress. You can customise the time and frequency, or turn it off entirely.",
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: "GotThis supports habits (daily/weekly recurring), outcomes (one-time targets with a deadline), and milestones (multi-step projects). You can set a target value, unit, and cadence for each.",
      },
      {
    ...
    <PublicLayout>
      <div className="pub-faq-hero pub-section">
        <div className="pub-wrap">
          ...
          <p>Common questions about GotThis, how the bot works, and what to expect.</p>
        </div>
      </div>
