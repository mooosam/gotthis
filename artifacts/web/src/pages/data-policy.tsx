      ...
      <div className="pub-legal-body pub-section">
        <div className="pub-legal-grid pub-wrap">
          ...
          <div className="pub-legal-content">
            <p>This Data Use Policy explains what personal data GotThis Ltd. collects, why we collect it, how we use it, and the rights you have over it. We are committed to handling your data with care, transparency, and respect.</p>

            <h2 id="who">1. Who We Are</h2>
            <p>GotThis Ltd. is the data controller for personal data collected through the gotthis.one website and service. If you have questions about this policy, contact us at <a href="mailto:privacy@gotthis.one">privacy@gotthis.one</a>.</p>
            ...
            <p>You can request early deletion by contacting <a href="mailto:privacy@gotthis.one">privacy@gotthis.one</a>.</p>
            ...
            <p>Despite these measures, no system is completely secure. Please notify us immediately at <a href="mailto:security@gotthis.one">security@gotthis.one</a> if you believe your account has been compromised.</p>
            ...
            <p>To exercise any of these rights, contact us at <a href="mailto:privacy@gotthis.one">privacy@gotthis.one</a>. We will respond within 30 days.</p>
            ...
            <p>GotThis is not intended for children under the age of 16. We do not knowingly collect personal data from anyone under 16. If you believe a child has provided us with personal data, please contact us immediately and we will delete it.</p>
            ...
            <p>For any privacy-related questions or requests, contact our Data Protection contact at <a href="mailto:privacy@gotthis.one">privacy@gotthis.one</a>, or via our <Link href="/contact">Contact page</Link>.</p>
          </div>
        </div>
      </div>
    </PublicLayout>
