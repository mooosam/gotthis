...
export default function SeoManager() {
  ...
  useEffect(() => {
    ...
    setJsonLd("gotthis-app-schema", index && (path === "/" || path === "/features" || entry?.kind === "landing") ? {"@context":"https://schema.org","@type":"SoftwareApplication",name:"GotThis",url:SITE_URL,applicationCategory:"ProductivityApplication",operatingSystem:"Web, WhatsApp",description:"GotThis helps people track goals, report progress and stay accountable through WhatsApp.",image:DEFAULT_IMAGE}:null);
